...
var facilities = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.circleMarker(latlng, geojsonMarkerOptions);
  },
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.Name + "</td></tr>" + "<tr><th>Facility ID</th><td>" + feature.properties.FacilityID + "</td></tr>" + "<tr><th>Unit ID</th><td>" + feature.properties.UnitID + "</td></tr>" + "<tr><th>Year</th><td>" + feature.properties.Year + "</td></tr>" + "<table>";
...
$.getJSON("data/facility.geojson", function (data) {
  facilities.addData(data);
});
...
$(document).one("ajaxStop", function () {
  map.fitBounds(facilities.getBounds());
  $("#loading").hide();
 ...
 var facilitiesBH = new Bloodhound({
    name: "PowerPlants",
    datumTokenizer: function (d) {
      return Bloodhound.tokenizers.whitespace(d.name);
    },
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    local: facilitiesSearch,
    limit: 10
  });
  ...
  // }, {
    name: "PowerPlants",
    displayKey: "Name",
    source: facilitiesBH.ttAdapter(),
    templates: {
      header: "<h4 class='typeahead-header'>&nbsp;Power Plants</h4>"
    }
  }, {
    name: "GeoNames",
    displayKey: "name",
